#!/usr/bin/env python3
"""
Comprehensive Test Suite for Enhanced Query Features
...
Uses the existing integrated_company_search_100_def.json dataset
"""
...
class EnhancedQueryFeaturesTestSuite:
    def __init__(self):
    ...
    def setup_test_environment(self):
        ...
        print("🔧 Setting up test environment for Enhanced Query Features...")
                    ...
                    for field, value in company.items():
                        if field not in ['company_name', 'company_ref_no'] and value:
                            if isinstance(value, list) and value:
                                fields_shown.append(f"{field}: {', '.join(str(v) for v in value[:2])}")
    ...
    def run_company_name_search_tests(self):
        ...
        self.run_query_test(
            "Exact Company Name Match - Company_006",
            "Company_006",
        ...
        self.run_query_test(
            "Multi-word Company Name - Alpha Design",
        ...
        self.run_query_test(
            "Partial Company Name Match - Garuda",
            "Garuda Defence",
        ...
        self.run_query_test(
            "Company Name with Special Characters - Paras Defence",
    ...
    def run_empty_field_filtering_tests(self):
        ...
        self.run_query_test(
            "Empty Field Filtering - Manufacturing Query",
    ...
    def run_result_limitation_tests(self):
        ...
        self.run_query_test(
            "Specific Result Limit - 5 Companies",
            "manufacturing companies",
        ...
        self.run_query_test(
            "Large Result Limit - 100 Companies",
            "companies",
        ...
        self.run_query_test(
            "Small Result Limit - 2 Companies",
            "aerospace companies",
    ...
    def run_cmp_prefix_tests(self):
        ...
        self.run_query_test(
            "CMP Prefix Handling - Defence Companies",
            "defence companies",
        ...
        self.run_query_test(
            "CMP Prefix Handling - Company_010",
            "Company_010",
    ...
    def run_clean_output_tests(self):
        ...
        self.run_query_test(
            "Clean Output Format - Software Companies",
            "software companies",
        ...
        self.run_query_test(
            "Clean Output Format - All Companies",
            "companies",
    ...
    def cleanup_previous_results(self):
        ...
        files_to_clean = [
            'enhanced_query_features_test_report.csv',
            'enhanced_query_features_test_results.json'
        ]
    ...
    def run_all_tests(self):
        ...
        print("🚀 Starting Enhanced Query Features Test Suite")
        print("="*80)
    ...
    def print_test_summary(self):
        ...
        print("\n" + "="*80)
        print("📊 ENHANCED QUERY FEATURES TEST SUMMARY")
        print("="*80)
        ...
        results_file = Path(__file__).parent / 'enhanced_query_features_test_results.json'
    ...
    def generate_csv_report(self):
        ...
        csv_file = Path(__file__).parent / 'enhanced_query_features_test_report.csv'
        ...
        for attempt in range(max_attempts):
            try:
                if attempt > 0:
                    csv_file = Path(__file__).parent / f'enhanced_query_features_test_report_{attempt}.csv'
...
def main():
    """Main test execution"""
    try:
        test_suite = EnhancedQueryFeaturesTestSuite()
