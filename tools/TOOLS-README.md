## This file is to store tools related to llama-cpp-python

```
# --- Activate environment ---
Write-Host "Activating virtual environment..." -ForegroundColor Green
& "$workFolder\venv\Scripts\Activate.ps1"

# --- Install prerequisites ---
Write-Host "Installing prerequisites..." -ForegroundColor Green
pip install -r "$workFolder\flat-file-approach\requirements.txt"
